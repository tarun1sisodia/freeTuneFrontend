...
PlaylistModel _playlistModelDeserialize(
  ...
  final object = PlaylistModel(
    coverArt: reader.readStringOrNull(offsets[0]),
    createdAt: reader.readDateTime(offsets[1]),
    description: reader.readStringOrNull(offsets[2]),
    id: reader.readString(offsets[3]),
    isPublic: reader.readBoolOrNull(offsets[4]) ?? false,
...
extension PlaylistModelByIndex on IsarCollection<PlaylistModel> {
  Future<PlaylistModel?> getById(String id) {
    return getByIndex(r'id', [id]);
  }

  PlaylistModel? getByIdSync(String id) {
  ...
  Future<List<PlaylistModel?>> getAllById(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
    return getAllByIndex(r'id', values);
  }

  List<PlaylistModel?> getAllByIdSync(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
...
extension PlaylistModelQueryFilter
  ...
  QueryBuilder<PlaylistModel, PlaylistModel, QAfterFilterCondition> idEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PlaylistModel, PlaylistModel, QAfterFilterCondition> idContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<PlaylistModel, PlaylistModel, QAfterFilterCondition> idMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
...
extension PlaylistModelQuerySortBy
  ...
  QueryBuilder<PlaylistModel, PlaylistModel, QAfterSortBy> sortByCoverArt() {
    return QueryBuilder.apply(this, (query) {
...
extension PlaylistModelQuerySortThenBy
  ...
  QueryBuilder<PlaylistModel, PlaylistModel, QAfterSortBy> thenByCoverArt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'coverArt', Sort.asc);
    });
  }
...
extension PlaylistModelQueryWhereDistinct
  ...
  QueryBuilder<PlaylistModel, PlaylistModel, QDistinct> distinctByCoverArt(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension PlaylistModelQueryProperty
  ...
  QueryBuilder<PlaylistModel, String?, QQueryOperations> coverArtProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PlaylistModel, String, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
